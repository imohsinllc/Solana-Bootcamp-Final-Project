...
pub fn mint(
	...
	coin: &mut AccountPDA<CoinMetadata>,
	funding: &AccountInfo,
    ...
    coin.data.source = source;
    coin.data.year = year;
    coin.data.short_description = short_description;
    coin.data.mint = *mint.info.key;
    coin.data.assoc_account = Some(*assoc_token_account.key);
